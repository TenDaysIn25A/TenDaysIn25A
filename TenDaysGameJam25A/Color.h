...
enum Pallet { CHOCO_MINT,  COUNT };

namespace ColorPallet {
inline Pallet pallet;

constexpr unsigned int BACK_GROUND[Pallet::COUNT] = {0x7A5F58FF};
constexpr unsigned int ENEMY[Pallet::COUNT] = {0xFA3F18FF};
constexpr unsigned int PLAYER[Pallet::COUNT] = {0xFFFFFFFF};
constexpr unsigned int PLAYER_ATTACK[Pallet::COUNT] = {0x37FABAFF};
constexpr unsigned int PLAYER_DEFENCE[Pallet::COUNT] = {0x37FABAFF};

constexpr unsigned int STAGE_1_BOSS[Pallet::COUNT] = {0x37FABAFF};
